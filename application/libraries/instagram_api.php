...
class Instagram_api {
    ...
    function __construct() {
        ...
        if ($this->codeigniter_instance->config->item('instagram_access_token')){
            // $this->load->library('session');
            $this->access_token = $this->codeigniter_instance->config->item('instagram_access_token');
        }
     ...
     */
    function getUserRecent($user_id = FALSE, $max_id = null, $min_id = null, $max_timestamp = null, $min_timestamp = null, $count = null) {

        $user_id = $user_id ? $user_id : $this->codeigniter_instance->config->item('instagram_user_id');
